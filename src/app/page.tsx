  ...
  <div className="text-center text-lg mx-4 hidden lg:block">
    ...
    <div className="rectangle">
      <div className='flex flex-col items-center justify-between'>
        ...
        <img src="https://images.rawpixel.com/image_png_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTA4L3Jhd3BpeGVsb2ZmaWNlMV9jdXRlXzNkX2lsbHVzdHJhdGlvbl9vZl9hX3N0YWNrX29mX2Jvb2tzX2lzb2xhdF81MjhhNmU5Ni0zZjllLTRlOGQtYmEyNy1lZGU3OWU0NTg0YTAucG5n.png" alt="" />   
        </div>    
    </div>
     <div className="arrow">{'=>'}</div>
     <div className="rectangle">
     <div className='flex flex-col items-center justify-between'>   
        Carica un file (pdf o immagine)
        e dai un nome alla tua richiesta 
        <div className='flex'>  
        <img src='https://w7.pngwing.com/pngs/49/1018/png-transparent-pdf-computer-icons-others-miscellaneous-text-rectangle.png' alt=''/>
        <img src='https://w7.pngwing.com/pngs/388/487/png-transparent-computer-icons-graphy-img-landscape-graphy-icon-miscellaneous-angle-text.png' alt=''/>
        </div> 
     </div>
     </div>
    </div>
    ...
    <div className="rectangle">
     ...
     <div className="arrow">{'=>'}</div>
     <div className="rectangle">
        Scegli la soluzione sulla base del prezzo e del feedback dell&apos;insegnante    
     </div>
    </div>
    <div className="flex justify-evenly">
    <div className="rectangle">
     ...
     <div className='flex flex-col items-center'>
        Lascia un feedback all&apos;insegnante per aiutare nella scelta i prossimi studenti  
        <img src="https://static.vecteezy.com/system/resources/thumbnails/012/871/551/small/rate-us-review-concept-review-customer-business-concept-png.png" alt="" /> 
        </div>
     </div>
    </div>
  </div>
...
<footer className="bg-white dark:bg-gray-900">
    ...
    <div className="px-4 py-6  dark:bg-gray-700 md:flex md:items-center md:justify-between">
        {/* <span className="w-full text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All Rights Reserved.
        </span> */}
    ...
    <span className="w-full text-sm text-gray-500 dark:text-gray-300 sm:text-center">© {year} <a href="#">Capstone™</a>. All Rights Reserved.
        </span>
        </div>
</footer>
