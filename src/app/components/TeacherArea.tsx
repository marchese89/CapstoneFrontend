...
export default function TeacherArea(): JSX.Element{
    ...
    <StyledTeacherArea>
        <div className="text-center">
          <h2 className="text-center font-semibold leading-7 text-gray-900 mt-4">Area insegnante</h2>
        </div>
        <div className="flex justify-center items-center">
              ...
              <button
                className={`${pathname === '/teacher_area/invoices' ? 'selected ':''}mt-4 flex justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600`}
