      ...
      <form onSubmit={register}>
        <div className="border-b border-gray-900/10 pb-12 tailwind-form max-w-screen-lg mx-4 sm:mx-8 md:mx-16 lg:mx-32 xl:mx-64 text-center">
          ...
          <div className="mt-4 text-left">
            <p>
              <strong>**</strong> La password deve avere almeno 10 caratteri, un
              numero, una lettera maiuscola una minuscola e almeno uno tra i
              seguenti caratteri speciali: (.:;?!@#,&gt;&lt;[]{}, inoltre non
              possono esserci più di due caratteri uguali ripetuti
            </p>
          </div>
