...
export default function Invoices(): JSX.Element {
  ...
  function getInvoices(page: number) {
    ...
    fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL}/invoices/byTeacher?page=${page}&size=5&direction=${sortDirection}&orderBy=issuingDate&year=${yearSelected}&month=${monthSelected}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
      ...
      <div className="flex items-center mb-4 justify-center">
        ...
        <div className="flex items-center">
          ...
          <select
            ...
            className="block w-full px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-500"
          >
            {yearsList &&
          ...
          <tbody className="bg-white">
            {invoicesList.map((invoice: Invoice, i: number) => (
              <tr key={i}>
                ...
                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-center whitespace-nowrap">
                  {invoice.total / 100}&nbsp;&euro;
                </td>
                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-center whitespace-nowrap">
                  <div className="flex justify-center">
                    <svg
                      onClick={() => {
                        router.push(`/teacher_area/invoices/${invoice.id}`);
                      }}
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
          ...
          {invoicesList.map((invoice: Invoice, i: number) => (
            <div key={i} className="flex justify-between flex-col request">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex justify-center">
                  {invoice.total / 100}&nbsp;<strong>&euro;</strong>
                </div>
              </div>
              <div className="flex justify-center">
                <svg
